      ...
      <div className="bg-white max-w-md w-full rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#25b461] hover:bg-[#1e914d] text-white py-3 rounded-lg font-bold text-lg shadow-md transition-all active:scale-95 disabled:opacity-70"
          >
...
<button
  ...
  className="w-full border border-gray-300 dark:border-gray-700 py-3 rounded-lg font-semibold text-[#2c3e50] dark:text-black-200 hover:bg-gray-50 dark:hover:bg-green-300 transition-all flex items-center justify-center gap-3 bg-white dark:bg-transparent"
>
